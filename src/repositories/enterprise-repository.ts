...
export interface EnterpriseRepository {
  ...
  // associateTasksToEnterprise(enterpriseId: number, taskIds: number[], tx?: Prisma.TransactionClient): Promise<void>;
  updateTaskStatus(
    enterpriseId: number,
    taskId: number,
    isCompleted: boolean,
  ...
  addChangeLog(data: {
    enterpriseId: number;
    changeType: EnterpriseChangeType | 'STATUS_CHANGED' | 'PHASE_CHANGED' | 'TASK_CHANGED';
    description: string;
