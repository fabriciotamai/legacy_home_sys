...
exports.sendDocumentsHandler = sendDocumentsHandler;
const make_send_document_use_case_1 = require("@/use-cases/factories/users/make-send-document-use-case");
const save_file_1 = require("@/utils/save-file");
const zod_1 = require("zod");
function sendDocumentsHandler(request, reply) {
    return __awaiter(this, void 0, void 0, function* () {
        var _a, e_1, _b, _c;
        const sendDocumentsSchema = zod_1.z.object({
            documentType: zod_1.z.enum(['RG', 'CNH', 'PASSPORT']),
        });
        try {
            if (!request.user) {
            ...
            try {
                for (var _d = true, parts_1 = __asyncValues(parts), parts_1_1; parts_1_1 = yield parts_1.next(), _a = parts_1_1.done, !_a; _d = true) {
                    ...
                    if (part.type === 'field') {
                        ...
                        documentFront = yield (0, save_file_1.saveFile)(part);
                    }
                    else if (part.fieldname === 'documentBack') {
                        documentBack = yield (0, save_file_1.saveFile)(part);
                    }
                    else if (part.fieldname === 'proofOfAddress') {
                        proofOfAddress = yield (0, save_file_1.saveFile)(part);
                    }
                    else if (part.fieldname === 'incomeTaxProof') {
                        incomeTaxProof = yield (0, save_file_1.saveFile)(part);
                    }
                }
            }
            ...
            const sendDocumentsUseCase = (0, make_send_document_use_case_1.makeSendDocumentsUseCase)();
